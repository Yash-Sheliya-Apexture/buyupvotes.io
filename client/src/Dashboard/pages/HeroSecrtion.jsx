...
const HeroSecrtion = () => {
  return (
    <div class="flex w-[70%] h-auto bg-[#FDE6D9] rounded-[30px] shadow-lg py-10 px-4 relative overflow-hidden">
      <div className="p-6">
        <h2 class="text-[30px] font-black text-[#004B50] mb-2 flex items-center leading-10">
          Welcome back, <br /> Rudra 👋
        </h2>
        <p class="text-[#004B50] font-semibold mb-6 max-w-[300px]">
          You have 100 upvotes remaining on your balance. Continue boosting your
          Reddit experience by placing an order!
        </p>
        <button class="px-4 py-1 bg-[#FF5700] text-white font-bold rounded-full hover:shadow-base">
          Order Now
        </button>
      </div>
      <div className="">
